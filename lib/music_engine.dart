class MusicEngine {
  ...
  static const Map<String, Map<int, List<int>>> instrumentTunings = {
    'Bass': {
      ...
      104: [7, 2, 9, 2],         // Drop D: G, D, A, D
      105: [7, 2, 9, 4, 9],      // Drop A (5-string): G, D, A, E, A
    },
    'Guitar': {
          6: [4, 11, 7, 2, 9, 4],     // E, B, G, D, A, E
          7: [4, 11, 7, 2, 9, 4, 11],  // E, B, G, D, A, E, B
          106: [4, 11, 7, 2, 9, 2],    // Drop D: E, B, G, D, A, D
    }
  };
  ...
  static const Map<String, Map<String, String>> translations = {
      'en': {
        ...
        'Augmented': 'Augmented',
        'Super Locrian': 'Super Locrian (Altered)',
      ...
      'es': {
        ...
        'Augmented': 'Aumentada',
        'Super Locrian': 'Superlocria (Alterada)',
